...
Mobile.setText(findTestObject('repoSpacestock/contactSearch'), 'bambang', 
    0)

Mobile.tap(findTestObject('repoSpacestock/android.widget.TextView - Bambang Gentolet'), 0)

Mobile.delay(5, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyElementText(findTestObject('repoSpacestock/android.widget.TextView - Bambang Gentolet (1)'), 'Bambang Gentolet')
