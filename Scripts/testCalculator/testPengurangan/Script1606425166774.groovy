...
Mobile.tap(findTestObject('operationRepo/android.widget.Button - kurang'), 0)

Mobile.tap(findTestObject('numberRepo/android.widget.Button - 8'), 0)

Mobile.verifyElementAttributeValue(findTestObject('operationRepo/android.widget.TextView'), '1', '1', 0)
